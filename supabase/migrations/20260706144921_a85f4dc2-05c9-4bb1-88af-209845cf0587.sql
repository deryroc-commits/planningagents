-- Ajoute une date d'expiration optionnelle aux liens de partage QR
alter table public.agent_share_links
  add column if not exists expires_at timestamptz;

-- La fonction de lecture publique respecte désormais l'expiration du lien.
