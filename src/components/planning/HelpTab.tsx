  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        text: "Si votre domaine personnel (erick-duvall-app.fr) est bloqué par le réseau professionnel, ouvrez directement l'adresse de secours https://planningagentsucpa.lovable.app/auth dans votre navigateur. Vous y retrouvez les mêmes comptes et données ; l'accès reste soumis à l'autorisation de l'administrateur (code d'invitation).",
      },
    ],
    tips: [
