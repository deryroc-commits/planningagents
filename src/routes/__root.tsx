  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Planning agents UCPA — Cuisine centrale" },
      {
        ...
        content:
          "Gestion du planning annuel des agents UCPA : planning, paramètres, base agents, impression.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Planning agents UCPA — Cuisine centrale" },
      { name: "description", content: "Schedule Master is a web application for managing agent schedules, replicating complex Excel planning functionality." },
      { property: "og:description", content: "Schedule Master is a web application for managing agent schedules, replicating complex Excel planning functionality." },
      { name: "twitter:description", content: "Schedule Master is a web application for managing agent schedules, replicating complex Excel planning functionality." },
